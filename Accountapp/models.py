...
class AccountingEntry(models.Model):
    ...
    charge_by = models.ForeignKey(charge, on_delete=models.CASCADE, null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        if not self.voucher and not self.pk:
            ...
            last_number = int(last_voucher.voucher.split('-')[-1]) if last_voucher else 0
    ...
    instrument = models.CharField(max_length=10,null=True,blank=True, choices=[('cash', 'Cash'), ('cheque', 'Cheque'), ('online', 'Online Transfer')])
